        ...
        <div class="container px-4">
          ...
          <form method="POST" action="{{ route('signup.perform') }}" id="finalSignupForm">
            ...
            @if(session('signup.otp_verified'))
              <button id="signUpButtonVerified" type="submit" class="btn w-75 mb-4 d-block mx-auto" style="background-color: #ff2d55; color: white; padding: 10px; font-weight: 600; border-radius: 8px; border: none; font-size: 16px;">
                Sign Up
              </button>
            @else
              <button id="signUpButton" type="button" class="btn w-75 mb-4 d-block mx-auto" disabled style="background-color: #e0e0e0; color: #9e9e9e; padding: 10px; font-weight: 600; border-radius: 8px; border: none; font-size: 16px; cursor: not-allowed;">
                Sign Up
              </button>
            @endif
          </form>
